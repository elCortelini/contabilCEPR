...
import { Plus, Search, Trash2, TrendingDown, Wallet, Building2, Printer, Calendar, RefreshCw } from 'lucide-react';
...
export const Saidas: React.FC = () => {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      {/* Filter Bar with All 4 Filters: Search, Carteira, Forma Pagamento, Data Inicio & Fim */}
